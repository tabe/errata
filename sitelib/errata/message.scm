(library (errata message)
  ...
  (gettext
   ...
   (are-you-sure-to-cancel-account? (en "Are you sure to cancel your account?")
                                    (ja "アカウントを解除しますか?(アカウントを解除するとこれまでに登録されたデータが利用できなくなります。)"))
   ...
   (do-you-want-to-make-exlibris-shared? (en "Do you want to make the exlibris shared?")
                                         (ja "この蔵書を公開しますか?(あとから公開/非公開にすることができます。)"))
