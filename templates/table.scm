...
(html
 (head
  ...
  (script ((type "text/javascript"))
          "$(document).ready(function() {$('div#links').corner();$('#menus').corner();$('.corner').corner();$('.dog').corner('dog tr 15px');});")
  )
 (body
  (div ((id "links")) links)
  (div ((id "menus")) revision-window)
  (div ((id "bottom")) "generated by template 'table'")
  ))
